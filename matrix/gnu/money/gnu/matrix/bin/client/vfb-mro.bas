...
'/
Declare Function AB ( ByRef Math As Integer, ByRef Physics As Integer, ByRef Sciences As Integer) As Integer

Type Math
    Dim MathTypes As Integer 
End Type 

Type Physics
   Dim PhysicsEvent As Integer
End Type 

Type Sciences
    Dim SciencesObjes As Integer
End Type 
